...
describe('ConferenceTable', () => {
  it('shows conferences', () => {
    ...
    expect(
      getByText(new Date(conferenceMocks[0].date).toLocaleDateString(i18n.language))
    ).toBeInTheDocument();
    expect(
      getByText(new Date(conferenceMocks[1].date).toLocaleDateString(i18n.language))
    ).toBeInTheDocument();
  });
  ...
  it('shows no conferences message', () => {
    ...
    expect(
      queryByText(new Date(conferenceMocks[0].date).toLocaleDateString(i18n.language))
    ).not.toBeInTheDocument();
    expect(
      queryByText(new Date(conferenceMocks[1].date).toLocaleDateString(i18n.language))
    ).not.toBeInTheDocument();
